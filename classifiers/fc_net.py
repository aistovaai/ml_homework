...
с градиентами функции потерь относительно этих параметров.
        ...
        # аффинный + ReLU
        out_layer1, cache_layer1 = affine_relu_forward(X, W1, b1)
        
        # аффинный
        scores, cache_layer2 = affine_forward(out_layer1, W2, b2)
        ...
        # второй
        dout1, dw2, db2 = affine_backward(dloss, cache_layer2)
        grads['W2'] = dw2 + self.reg * W2
        grads['b2'] = db2
        
        # первый
        dx, dw1, db1 = affine_relu_backward(dout1, cache_layer1)
